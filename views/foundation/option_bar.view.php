...
<div class="container-fluid">
    <div id="optionbar" class=" large-3" style="display: none  ;">
        <div class="panel panel-default " style="overflow: auto">
            ...
            <div class="panel-body">
                ...
                <form id="form_option" autocomplete="off" onsubmit="return false;">
                    ...
                    <div>
                        <label for=""><h5>Side bar:</h5></label>
                        ...
                        <div>
                            ...
                            <div>
                                <dl class="tabs">
                                    <dd id="tab_left" class="active" ><a href="#">Left</a></dd>
                                    <dd id="tab_right"><a href="#">Right</a></dd>
                                </dl>
                            </div>
