...
<div class="container-fluid">
    <div id="optionbar" class=" large-3" style="display: none  ; overflow: auto">
        <div class="panel panel-default ">
            <div class="panel-heading">

                <h4 class="panel-title"> Personnalisation:</h4> <h6>(Appuyer sur ENTREE pour valider une
                    modification)</h6>

            </div>
            <div class="panel-body">

                <form id="form_option" name="form_option" autocomplete="off" onsubmit="return false;">
                    ...
                    <p>
                        ...
                        <button id="style_refresh" name ="style_refresh" style="display: none">Rafraîchir les styles</button>
                    </p>
                    ...
                    ?></textarea>
                    <button id="style_submit" name ="style_submit">Enregistrer</button>
                    </p>
