...
if($config["theme_name"] == "bootstrap")
{
    ...
    $tab_skin = array_diff(scandir("static/apps/noviusos_templates_e/vendor/".$config["theme_name"]."/less/skin"), array('..', '.' ));
...
else if($config["theme_name"] == "foundation")
{
    ...
    $tab_skin = array_diff(scandir("static/apps/noviusos_templates_e/vendor/".$config["theme_name"]."/sass/skin"), array('..', '.' ));
